...
> **Professor:** Américo
> **Equipe:** Wanessa Vieira e Luis Gustavo
...
| :----------------- | :--------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Produtos** | •**Controller** (`ProdutoController`)• **Information Expert** (`Produto.dadosValidos()`) | •**Factory** (`ProdutoFactory`)• **Strategy** (`PrecoStrategy`, `PrecoNormalStrategy`, `PrecoPromocionalStrategy`)             |
| **Clientes** | •**Controller** (`ClienteController`)• **Information Expert** (`Cliente.dadosValidos()`) | •**Factory** (`ClienteFactory`)• **Strategy** (`DescontoClienteStrategy`, `ClienteComumStrategy`, `ClienteFidelidadeStrategy`) |
